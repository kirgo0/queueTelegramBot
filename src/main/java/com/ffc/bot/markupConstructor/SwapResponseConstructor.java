...
public class SwapResponseConstructor {

    public static List<BotApiMethod> getSwapResponse(String chatId, String firstUserId, String secondUserId, int firstUserPos, int secondUserPos) {
